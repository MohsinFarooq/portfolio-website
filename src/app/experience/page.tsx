          ...
          <ul className="timeline bg-dark-cards_200 rounded-3xl p-6 m-6 timeline-snap-icon max-md:timeline-compact timeline-vertical">
            <li>
              ...
              <div className="timeline-start mb-10 md:text-end">
                ...
                <p>
                  In my current role, I work on integrating APIs from the
                  backend into the frontend to enable efficient data fetching
                  and user interactions. I am responsible for end-to-end testing
                  using Cypress, maintaining build processes on Jenkins,
                  troubleshooting UI bugs, and managing GitLab pipelines and
                  webhooks. This position has strengthened my skills in Angular
                  development, testing, and CI/CD practices
                </p>
              </div>
              <hr />
            </li>
