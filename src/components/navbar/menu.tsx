...
export default function MenuItem() {
  return (
    <Menu as="div" className="text-left block lg:hidden">
      ...
      >
        <Menu.Items className="absolute px-8 bg-dark-cards_200 right-0 z-10 lg:mr-4 w-full md:max-w-full md:w-screen divide-y divide-white mt-4 origin-top-0 bg-dark-200 text-white focus:outline-none py-2 rounded-3xl">
